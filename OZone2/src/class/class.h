...
static struct method input_getjoysticks_method = { input_getjoysticks_name, list_class_type, 1, input_getjoysticks };
...
static struct method floppydrive_getfiles_method = { floppydrive_getfiles_name, list_class_type, 0, floppydrive_getfiles };
